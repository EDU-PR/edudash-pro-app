...
import { sendMessagePushNotification, getSenderDisplayName } from '@/lib/messaging/pushNotifications';
import type { MessageThread, MessageParticipant, Message } from '@/lib/messaging/types';

// Re-export shared types for backward compatibility
export type { MessageThread, MessageParticipant, Message } from '@/lib/messaging/types';

// Push notification helper and types are now imported from @/lib/messaging
