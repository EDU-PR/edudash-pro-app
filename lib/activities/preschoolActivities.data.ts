...

  {
    ...
    rounds: [
      ...
      },
      {
        ...
        options: [
          { id: 'a', label: 'Octopus 🐙', isCorrect: true },
          { id: 'b', label: 'Fish 🐠', isCorrect: true },
          { id: 'c', label: 'Dolphin 🐬', isCorrect: true },
          { id: 'd', label: 'Crab 🦀', isCorrect: true },
        ],
