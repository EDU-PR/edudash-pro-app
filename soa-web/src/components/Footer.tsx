        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <a href="https://wa.me/27762233981" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-green-600 transition">
            ...
            <div className="flex items-center gap-2 text-xs text-gray-500">
              ...
              <Link
                ...
                target="_blank"
                className="inline-flex items-center gap-1 text-edudash-primary hover:underline"
              >
                EduDash Pro
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6 text-sm">
              ...
              <Link
                href="https://edudashpro.org.za"
                target="_blank"
                className="text-edudash-primary hover:text-edudash-secondary transition flex items-center gap-1"
              >
                EduDash Pro
                <ExternalLink className="w-3 h-3" />
              </Link>
