...
$SUPABASE_CMD secrets set --project-ref "$SUPABASE_PROJECT_REF" PAYFAST_MERCHANT_KEY=REDACTED
echo "✅ Set PAYFAST_MERCHANT_KEY"

$SUPABASE_CMD secrets set --project-ref "$SUPABASE_PROJECT_REF" PAYFAST_PASSPHRASE=REDACTED
