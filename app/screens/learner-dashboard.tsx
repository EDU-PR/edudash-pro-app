...
export default function LearnerDashboard() {
  ...
  useEffect(() => {
    ...
    if (!orgId) {
      navigationAttempted.current = true;
      console.log('Learner dashboard: No school found, redirecting to onboarding', {
        profile,
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <Text style={styles.heading}>{t('learner.welcome', { defaultValue: 'Welcome to your Learning Space' })}</Text>
        <Text style={styles.subheading}>{t('learner.description', { defaultValue: 'Your courses, progress, and certificates will appear here.' })}</Text>
      </ScrollView>
    </View>
  );
}
