    ...
    <div className="chat-root" style={{
      ...
      <div className="chat-scroll" style={{
        ...
        <div className="messages-container" style={{
          padding: '20px 16px 120px 16px', // Increased bottom padding to account for selected images + input
          display: 'flex',
          flexDirection: 'column',
          gap: 16,
          width: '100%',
      ...
      {/* Input Area - Fixed Bottom within Chat Interface */}
