...
export default function TrainingCentersPage() {
  ...
  return (
    ...
    >
      <h1 className="h1">Training Centers</h1>
      <p style={{ marginTop: 8, marginBottom: 24, fontSize: 16, color: 'var(--muted)' }}>
        Manage physical training locations
      </p>

      <div className="card" style={{ padding: 80, textAlign: 'center' }}>
        <Building2 style={{ width: 64, height: 64, margin: '0 auto 24px', color: 'var(--muted)', opacity: 0.5 }} />
        ...
        <p style={{ fontSize: 16, color: 'var(--muted)', maxWidth: 400, margin: '0 auto' }}>
          Training center management will be available in the next update
        </p>
      </div>
    </TertiaryShell>
  );
