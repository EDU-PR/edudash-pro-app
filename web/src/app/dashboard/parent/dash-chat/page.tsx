          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 md:gap-3 min-w-0">
              ...
              <div className="min-w-0 flex-1">
                <h1 className="m-0 text-base md:text-lg font-bold bg-gradient-to-r from-purple-200 to-pink-200 bg-clip-text text-transparent">Dash AI</h1>
            ...
            {hydrated && !activeConversationId && (
              <div className="flex flex-1 items-center justify-center overflow-hidden p-4">
                <div className="max-w-md w-full text-center flex flex-col items-center gap-4">
                  ...
                  <h2 className="text-xl md:text-2xl font-bold m-0 bg-gradient-to-r from-purple-200 to-pink-200 bg-clip-text text-transparent">Start Your First Chat</h2>
