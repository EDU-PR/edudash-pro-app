...
export default function GradingPage() {
  ...
  return (
    ...
    >
      <h1 className="h1">Grading Center</h1>
      <p style={{ marginTop: 8, marginBottom: 24, fontSize: 16, color: 'var(--muted)' }}>
        Review and grade student submissions
      </p>

      <div className="card" style={{ padding: 80, textAlign: 'center' }}>
        <CheckCircle style={{ width: 64, height: 64, margin: '0 auto 24px', color: 'var(--muted)', opacity: 0.5 }} />
        ...
        <p style={{ fontSize: 16, color: 'var(--muted)', maxWidth: 400, margin: '0 auto' }}>
          Grading interface with AI assistance will be available soon
        </p>
      </div>
    </TertiaryShell>
  );
