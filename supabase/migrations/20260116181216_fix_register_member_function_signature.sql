-- Fix function overloading issue with register_organization_member
-- PostgreSQL creates separate functions when parameter signatures differ
-- This migration drops all existing function overloads and creates the definitive one
